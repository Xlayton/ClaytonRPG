...
public class ConsoleUI {
  ...
  public static <T extends EnumMenuSelection> T promptForMenuSelection(
      String prompt, T[] enumOptions) {
    printLine(prompt + ": ");
   ...
   * method is called with a trueString argument of "yes" and a falseString argument of "no". If the
   * enters "YES", the method returns true. If the user enters "no", the method returns false. All
   * other inputs are considered invalid, the user will be informed, and the prompt will repeat.
   *
  ...
  /**
   * Generates a prompt that expects a numeric input representing a double value. This method loops
   * until valid input is given.
   *
   * @param prompt - the prompt to be displayed to the user
   * @param min - the inclusive minimum boundary
   ...
   * allowEmpty is true, empty responses are valid. When false, responses must contain at least one
  ...
  /**
   * Generates a prompt that expects a single character input representing a char value. This method
